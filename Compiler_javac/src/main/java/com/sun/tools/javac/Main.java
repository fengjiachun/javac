 ...
 * Java的编译器接口， javac
 * <p>
 * Except for the two methods {@link #compile(java.lang.String[])} {@link #compile(java.lang.String[],java.io.PrintWriter)}, nothing described in this source
 * file is part of any supported API. If you write code that depends on this, you do so at your own risk. This code and its internal interfaces are subject to
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		/*
		 * 第一个参数是"-Xjdb"时，会抛出以下异常：
		 * Exception in thread "main" java.lang.ClassNotFoundException: com.sun.tools.example.debug.tty.TTY
		 * 必须引入这个类以及相关的类，com.sun.tools.example.debug.tty.TTY
		 * 在这个路径下OpenJDK1.7\openjdk\jdk\src\share\classes\com\sun\tools\example\debug\tty
		 */
