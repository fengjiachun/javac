 ...
 * 抽象语法树的 Root class，以内嵌子类的方式表示一些特定的树节点
...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
     ...
     */
    public static final int  TOPLEVEL = 1;                  // JCCompilationUnit

    /** Import clauses, of type Import.
     */
    public static final int IMPORT = TOPLEVEL + 1;          // JCImport

    /** Class definitions, of type ClassDef.
     */
    public static final int CLASSDEF = IMPORT + 1;          // JCClassDecl

    /** Method definitions, of type MethodDef.
     */
    public static final int METHODDEF = CLASSDEF + 1;       // JCMethodDecl

    /** Variable definitions, of type VarDef.
     */
    public static final int VARDEF = METHODDEF + 1;         // JCVariableDecl

    /** The no-op statement ";", of type Skip
     */
    public static final int SKIP = VARDEF + 1;              // JCSkip

    /** Blocks, of type Block.
     */
    public static final int BLOCK = SKIP + 1;               // JCBlock

    /** Do-while loops, of type DoLoop.
     */
    public static final int DOLOOP = BLOCK + 1;             // JCDoWhileLoop

    /** While-loops, of type WhileLoop.
     */
    public static final int WHILELOOP = DOLOOP + 1;         // JCWhileLoop

    /** For-loops, of type ForLoop.
     */
    public static final int FORLOOP = WHILELOOP + 1;        // JCForLoop

    /** Foreach-loops, of type ForeachLoop.
     */
    public static final int FOREACHLOOP = FORLOOP + 1;      // JCEnhancedForLoop

    /** Labelled statements, of type Labelled.
     */
    public static final int LABELLED = FOREACHLOOP + 1;     // JCLabeledStatement

    /** Switch statements, of type Switch.
     */
    public static final int SWITCH = LABELLED + 1;          // JCSwitch

    /** Case parts in switch statements, of type Case.
     */
    public static final int CASE = SWITCH + 1;              // JCCase

    /** Synchronized statements, of type Synchonized.
     */
    public static final int SYNCHRONIZED = CASE + 1;        // JCSynchronized

    /** Try statements, of type Try.
     */
    public static final int TRY = SYNCHRONIZED + 1;         // JCTry

    /** Catch clauses in try statements, of type Catch.
     */
    public static final int CATCH = TRY + 1;                // JCCatch

    /** Conditional expressions, of type Conditional.
     */
    public static final int CONDEXPR = CATCH + 1;           // JCConditional

    /** Conditional statements, of type If.
     */
    public static final int IF = CONDEXPR + 1;              // JCIf

    /** Expression statements, of type Exec.
     */
    public static final int EXEC = IF + 1;                  // JCExpressionStatement

    /** Break statements, of type Break.
     */
    public static final int BREAK = EXEC + 1;               // JCBreak

    /** Continue statements, of type Continue.
     */
    public static final int CONTINUE = BREAK + 1;           // JCContinue

    /** Return statements, of type Return.
     */
    public static final int RETURN = CONTINUE + 1;          // JCReturn

    /** Throw statements, of type Throw.
     */
    public static final int THROW = RETURN + 1;             // JCThrow

    /** Assert statements, of type Assert.
     */
    public static final int ASSERT = THROW + 1;             // JCAssert

    /** Method invocation expressions, of type Apply.
     */
    public static final int APPLY = ASSERT + 1;             // JCMethodInvocation

    /** Class instance creation expressions, of type NewClass.
     */
    public static final int NEWCLASS = APPLY + 1;           // JCNewClass

    /** Array creation expressions, of type NewArray.
     */
    public static final int NEWARRAY = NEWCLASS + 1;        // JCNewArray

    /** Parenthesized subexpressions, of type Parens.
     */
    public static final int PARENS = NEWARRAY + 1;          // JCParens

    /** Assignment expressions, of type Assign.
     */
    public static final int ASSIGN = PARENS + 1;            // JCAssign

    /** Type cast expressions, of type TypeCast.
     */
    public static final int TYPECAST = ASSIGN + 1;          // JCTypeCast

    /** Type test expressions, of type TypeTest.
     */
    public static final int TYPETEST = TYPECAST + 1;        // JCInstanceOf

    /** Indexed array expressions, of type Indexed.
     */
    public static final int INDEXED = TYPETEST + 1;         // JCArrayAccess

    /** Selections, of type Select.
     */
    public static final int SELECT = INDEXED + 1;           // JCFieldAccess

    /** Simple identifiers, of type Ident.
     */
    public static final int IDENT = SELECT + 1;             // JCIdent

    /** Literals, of type Literal.
     */
    public static final int LITERAL = IDENT + 1;            // JCLiteral

    /** Basic type identifiers, of type TypeIdent.
     */
    public static final int TYPEIDENT = LITERAL + 1;        // JCPrimitiveTypeTree

    /** Array types, of type TypeArray.
     */
    public static final int TYPEARRAY = TYPEIDENT + 1;      // JCArrayTypeTree

    /** Parameterized types, of type TypeApply.
     */
    public static final int TYPEAPPLY = TYPEARRAY + 1;      // JCTypeApply

    /** Union types, of type TypeUnion
     */
    public static final int TYPEUNION = TYPEAPPLY + 1;      // JCTypeUnion

    /** Formal type parameters, of type TypeParameter.
     */
    public static final int TYPEPARAMETER = TYPEUNION + 1;  // JCTypeParameter

    /** Type argument.
     */
    public static final int WILDCARD = TYPEPARAMETER + 1;   // JCWildcard
    ...
    /** metadata: Annotation.
     */
    public static final int ANNOTATION = TYPEBOUNDKIND + 1; // JCAnnotation

    /** metadata: Modifiers
     */
    public static final int MODIFIERS = ANNOTATION + 1;     // JCModifiers

    public static final int ANNOTATED_TYPE = MODIFIERS + 1; // 这个版本好像暂时不支持

    /** Error trees, of type Erroneous.
     */
    public static final int ERRONEOUS = ANNOTATED_TYPE + 1; // JCErroneous
     ...
     * 每个内嵌子类要实现这个方法，返回一个Tag，代表这个树的类型，就是上面定义的那些常量
     */
    ...
    /**
     * 最顶层的抽象语法树(abstract syntax tree)
    ...
    public static class JCCompilationUnit extends JCTree implements CompilationUnitTree {
        public List<JCAnnotation> packageAnnotations;       // 包上注解(package-info.java)
        public JCExpression pid;                            // The tree representing the package clause. 包名
        public List<JCTree> defs;                           // 这个文件当中的所有定义(类定义、Import或跳过的)
        public JavaFileObject sourcefile;                   // sourcefile
        public PackageSymbol packge;                        // The package it belongs to.
        public ImportScope namedImportScope;                // A scope for all named imports.
        public StarImportScope starImportScope;             // A scope for all named imports.
        public long flags;
        public Position.LineMap lineMap = null;             // Line starting positions, defined only : if option -g is set.调试信息相关
        // A hashtable that stores all documentation comments
        // indexed by the tree nodes they refer to.
        // defined only if option -s is set.    -s <目录> 指定生成的源文件的位置
        public Map<JCTree, String> docComments = null;
        // A hashtable that stores ending positions of source
        // ranges indexed by the tree nodes they belong to.
        // Defined only if option -Xjcov is set.
    ...
    /** 以语法分析：int y = x + 100;这个表达式为例：
    ------------------------------------------------------------------------------------------------
                                 JCVariableDecl
           ______________________/      |     \________________
          /                             |                      \
       vartype                         name                   init
    JCTree$JCPrimitiveTypeTree         Name              JCTree$JCBinary
      typetag:4                         y                /      (+)     \
        (int)                                           /        |       \
                                              ________ /         |        \_______
                                             /                   |                \
                                           ...
                                           /                     |                  \ 
                                       lhs                   operator               rhs     
                                  JCTree$JCIdent         OperatorSymbol       JCTree$JCLiteral
                                        |                 + (int, int)            value:100
                                        |   
                                        |               要等到语义分析阶段判
                                       Name             断出表达式类型后才会
     ...
     * Modifier = PUBLIC | PROTECTED | PRIVATE | STATIC | ABSTRACT | FINAL | NATIVE | SYNCHRONIZED | TRANSIENT | VOLATILE | "@" | "@" Annotation
     */
    public static class JCModifiers extends JCTree implements com.sun.source.tree.ModifiersTree {
        /*
            flags可能是以下标识中的几个组成的合集:
